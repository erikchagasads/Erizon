...
// src/components/dados/StatusContaDominante.tsx — v3.0
// Reescrito para usar HealthResult (ContaHealth) do algoritmoErizon v6.2
        ...
        <div className="flex items-start gap-5 px-7 py-6 md:min-w-[320px] shrink-0">
          <div className="relative mt-1">
            <svg width="72" height="72" viewBox="0 0 72 72">
              ...
              <circle cx="36" cy="36" r={r} fill="none" stroke={scoreColor} strokeWidth="4"
