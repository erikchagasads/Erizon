        ...
        <div className="w-full max-w-[380px]">
          ...
          <div className="mt-8 flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-3 mt-2">
              <Link href="/privacidade" className="text-[10px] text-white/15 hover:text-white/40 transition-colors">
                Privacidade
              </Link>
              <span className="text-white/10">·</span>
              <Link href="/termos" className="text-[10px] text-white/15 hover:text-white/40 transition-colors">
                Termos de Uso
              </Link>
            </div>
          </div>
