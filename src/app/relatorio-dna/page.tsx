...
// app/relatorio-dna/page.tsx — Relatório Profit DNA Premium
// Documento de inteligência que o gestor entrega ao cliente mensalmente.
// Transforma dados internos em narrativa de valor visível.
// Posiciona o gestor como parceiro estratégico, não executor de anúncio.
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-transparent p-6">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-[10px] text-purple-400 uppercase tracking-widest font-semibold mb-1">Relatório de Inteligência</p>
          ...
          <div className="flex items-center gap-1 px-3 py-1.5 rounded-full border border-purple-500/30 bg-purple-500/10">
            ...
            <span className="text-[11px] text-purple-300 font-semibold">{confianca}% confiança</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 mt-5">
          ...
          {dna.avgBudgetWinner !== null && (
            <div className="text-center">
              ...
              <p className="text-[10px] text-white/30 mt-0.5">Budget campeão/dia</p>
            </div>
          )}
        </div>
      </div>
      ...
      {/* Golden Audience */}
      {dna.goldenAudience && (
        <Section title="Público campeão identificado" icon={Award}>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/30 mt-1">
                Este público apresentou o melhor equilíbrio entre CPL, ROAS e taxa de fechamento nas campanhas analisadas.
              </p>
            </div>
          </div>
        </Section>
            ...
            {dna.bestFormats.slice(0, 4).map((f, i) => (
              <div key={i} className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-[11px]">
                  <span className="text-white/40">CPL médio: <span className="text-white">{fmtBRL(f.avgCpl)}</span></span>
      ...
      {dna.keyLearnings.length > 0 && (
        <Section title="Aprendizados estratégicos" icon={Zap}>
          <div className="space-y-3">
      ...
      <div className="flex items-start gap-3 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
        ...
        <p className="text-[11px] text-white/30 leading-relaxed">
          Este relatório é gerado automaticamente pela Erizon com base em {dna.nSnapshotsAnalyzed} snapshots de dados reais.
          Período: {dna.periodStart ? new Date(dna.periodStart).toLocaleDateString("pt-BR") : "—"} a{" "}
          {dna.periodEnd ? new Date(dna.periodEnd).toLocaleDateString("pt-BR") : "—"}.
          Compartilhe este documento com seu cliente como prova de inteligência estratégica acumulada.
        </p>
      </div>
    </div>
  );
      ...
      <div className="md:ml-[60px] pb-20 md:pb-0 min-h-screen bg-[#040406] text-white">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="mb-8 flex items-start justify-between">
            <div>
              <p className="text-[11px] text-purple-400 font-semibold uppercase tracking-wider mb-1">Relatório Premium</p>
              <h1 className="text-2xl font-bold text-white">Profit DNA</h1>
              <p className="text-sm text-white/40 mt-1">
                Inteligência acumulada do cliente. Entregue mensalmente e justifique seu valor como gestor.
              </p>
            </div>
            {dna && (
            ...
            <>
              ...
              {loading ? (
                <div className="flex flex-col items-center justify-center py-20 gap-3">
                  ...
                  <p className="text-white/30 text-sm">Processando inteligência acumulada...</p>
                </div>
              ) : !dna ? (
                <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-10 text-center">
                  ...
                  <p className="text-white/20 text-xs mt-1">São necessários ao menos 7 snapshots de campanha para análise.</p>
                </div>
              ) : (
